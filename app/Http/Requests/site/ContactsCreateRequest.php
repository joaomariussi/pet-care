...
class ContactsCreateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'state_uf'      => 'required|string|max:191',
    ...
    public function messages(): array
    {
        return [
            ...
            'email.max'             => 'O e-mail não pode ter mais de 191 caracteres.',
