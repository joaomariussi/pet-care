(function (window, document, $) {
  ...
  if ($('.customizer-content').length > 0) {
    let customizer_content = new PerfectScrollbar('.customizer-content', {
  ...
  $("#customizer-navbar-colors .color-box").on("click", function () {
    ...
    $this.siblings().removeClass('selected');
    $this.addClass("selected");
    let navbarColor = $this.data("navbar-color");
  ...
  $(window).scroll(function(){
    let navbarActiveColor = $("#customizer-navbar-colors .color-box.selected").data("navbar-color");
  ...
  if($(body).hasClass("horizontal-layout")){
    ...
    let navbarHorizontal = $('.header-navbar.navbar-horizontal');
