    ...
    <section class="insert-pet">
        <div class="row">
            <div class="col-12 col-xl-12">
                        ...
                        <div class="card-content">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb breadcrumb-cadastros">
                                    ...
                                    <li class="breadcrumb-item active">Editar Pet</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <b class="title-geral-etapas">Editar Pet - {{$pet->name}}</b>
                <p>Edite as informações do pet.</p>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control @error('species') is-invalid @enderror"
                                                                ...
                                                                <option value="Cachorro" {{ old('species', $pet->species) == 'Cachorro' ? 'selected' : '' }}>
                                                                    Cachorro
                                                                </option>
                                                                <option value="Gato" {{ old('species', $pet->species) == 'Gato' ? 'selected' : '' }}>
                                                                    Gato
                                                                </option>
                                                                <option value="Pássaro" {{ old('species', $pet->species) == 'Pássaro' ? 'selected' : '' }}>
                                                                    Pássaro
                                                                </option>
                                                                <option value="Roedor" {{ old('species', $pet->species) == 'Roedor' ? 'selected' : '' }}>
                                                                    Roedor
                                                                </option>
                                                                <option value="Réptil" {{ old('species', $pet->species) == 'Réptil' ? 'selected' : '' }}>
                                                                    Réptil
                                                                </option>
                                                                <option value="Outro" {{ old('species', $pet->species) == 'Outro' ? 'selected' : '' }}>
                                                                    Outro
                                                                </option>
                                                            </select>
                                                            @error('species')
                                                                ...
                                                                <div class="input-group-text">
                                                                    <input class="form-check-input mt-0" type="checkbox"
                                                                           value="Sem raça" name="no_race" id="no_race"
                                                                            {{ old('no_race', $pet->race == 'Sem raça' ? 'checked' : '') }}>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                   ...
                                                                   placeholder="Cor do Pet" value="{{ old('color', $pet->color) }}">
                                                            @error('color')
                                                            <div class="invalid-feedback">
                                                                {{$message}}
                                                            </div>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                   ...
                                                                   placeholder="Peso do Pet" value="{{ old('weight') ?? number_format($pet->weight, 3, ',', '.') }}">
                                                            @error('weight')
                                                            <div class="invalid-feedback">
                                                                {{$message}}
                                                            </div>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date"
                                                                   ...
                                                                   value="{{ old('date_birth', $pet->date_birth) }}">
                                                            @error('date_birth')
                                                            <div class="invalid-feedback">
                                                                {{$message}}
                                                            </div>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control @error('gender') is-invalid @enderror"
                                                                ...
                                                                <option value="Macho" {{ old('gender', $pet->gender) == 'Macho' ? 'selected' : '' }}>
                                                                    Macho
                                                                </option>
                                                                <option value="Fêmea" {{ old('gender', $pet->gender) == 'Fêmea' ? 'selected' : '' }}>
                                                                    Fêmea
                                                                </option>
                                                            </select>
                                                            @error('gender')
                                                            ...
                                                            is-invalid @enderror" id="medical_history_id" name="medical_history_id">
                                                                ...
                                                                @foreach($medicalHistories as $medicalHistory)
                                                                    <option value="{{ $medicalHistory->id }}"
                                                                            {{ old('medical_history_id', $pet->medical_history_id) == $medicalHistory->id ? 'selected' : '' }}>
