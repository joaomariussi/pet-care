                ...
                <div class="card-content">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-cadastros">
                            ...
                            <li class="breadcrumb-item">Pets</li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" id="contacts-tab" data-bs-toggle="tab" href="#contacts"
                               ...
                               aria-selected="true">
                                ...
                                <span class="align-middle">Pets</span>
                            </a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane active" id="contacts" aria-labelledby="contacts" role="tabpanel">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <b class="title-geral-etapas">Lista de Pets</b>
                                            <a href="{{route('pets.view-create')}}"
