                ...
                <div class="card-content">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-cadastros">
                            ...
                            <li class="breadcrumb-item">Histórico Médico</li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" id="contacts-tab" data-bs-toggle="tab" href="#contacts"
                               ...
                               aria-selected="true">
                                ...
                                <span class="align-middle">Histórico Médico</span>
                            </a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane active" id="contacts" aria-labelledby="contacts" role="tabpanel">
                                ...
                                <div class="col-xl-3 col-sm-6 col-md-6">
                                    <div class="card">
                                        <div class="card-body cards-geral">
                                            <i class="fa-solid fa-notes-medical font-large-1 color-green-dark-geral"></i>
                                            <div class="card-produtos-quantidade ms-3">
                                                <h5 class="mb-0 me-2 itenscadastrados registered-users color-green-dark-geral">
                                                    {{$totalMedicalHistory}}</h5>
                                                <b class="text-muted">Históricos Médicos Cadastrados</b>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <b class="title-geral-etapas">Lista de Históricos Médicos</b>
                                            <a href="{{route('medical-histories.view-create')}}"
                                               class="btn button_register float-end ms-2 buttonInsert">
                                                <i class='fa-solid fa-plus'></i> Novo Histórico Médico
                                            </a>
                                        </div>
                                        <div class="card-content">
