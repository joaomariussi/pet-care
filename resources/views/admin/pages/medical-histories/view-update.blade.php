...
@section('title', 'Edição de Histórico Médico')
    ...
    <section class="insert-positions">
        <div class="row">
            <div class="col-12 col-xl-12">
                ...
                <b class="title-geral-etapas">Editar Histórico Médico - {{$medicalHistory->id}}</b>
                <p>Edite as informações do Histórico Médico</p>

                <form method="POST" action="{{route('medical-histories.update', $medicalHistory->id)}}"
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            @enderror" id="pet_id" name="pet_id">
                                                                ...
                                                                @foreach($pets as $pet)
                                                                    <option value="{{ $pet->id }}"
                                                                            {{ old('pet_id', $medicalHistory->pet_id) == $pet->id ? 'selected' : '' }}>
                                                                        {{ $pet->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                            ...
                                                            @enderror" id="veterinarian_id" name="veterinarian_id">
                                                                ...
                                                                @foreach($veterinarians as $veterinarian)
                                                                    <option value="{{ $veterinarian->id }}"
                                                                            {{ old('veterinarian_id', $medicalHistory->veterinarian_id) == $veterinarian->id ? 'selected' : '' }}>
                                                                        {{ $veterinarian->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            is-invalid @enderror" id="diagnosis" name="diagnosis"
                                                                   placeholder="Ex: Raiva Canina"
                                                                   value="{{ old('diagnosis', $medicalHistory->diagnosis) }}">
                                                            @error('diagnosis')
                                                            <div class="invalid-feedback">
                                                                {{$message}}
                                                            </div>
                                                    ...
                                                    <div class="col-6 col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            is-invalid @enderror" id="treatment" name="treatment"
                                                                   ...
                                                                   value="{{ old('treatment', $medicalHistory->treatment) }}">
                                                            @error('treatment')
                                                            <div class="invalid-feedback">
                                                                {{$message}}
                                                            </div>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            value="{{ old('date', $medicalHistory->date) }}">
                                                            @error('date')
                                                            <div class="invalid-feedback">
                                                                {{$message}}
                                                            </div>
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            is-invalid @enderror" id="observations" name="observations"
                                                                   ...
                                                                   value="{{ old('observations', $medicalHistory->observations) }}">
                                                            @error('observations')
                                                            <div class="invalid-feedback">
                                                                {{$message}}
                                                            </div>
