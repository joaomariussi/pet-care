    ...
    <section class="insert-positions">
        <div class="row">
            <div class="col-12 col-xl-12">
                ...
                <b class="title-geral-etapas">Editar Categoria - {{$category->name}}</b>
                <p class="sub-title-geral-etapas">Edite as informações da categoria</p>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control @error('description') is-invalid @enderror"
                                                                      id="description" name="description" placeholder="Descrição da Categoria"
                                                                      rows="1" style="white-space: pre-wrap;">{{ old('description') ?? $category->description }}
                                                            </textarea>
                                                            @error('description')
                                                            <div class="invalid-feedback">
                                                                {{$message}}
