                        ...
                        <li class="nav-item">
                            <a class="nav-link active" id="contacts-tab" data-bs-toggle="tab" href="#contacts"
                               ...
                               aria-selected="true">
                                ...
                                <span class="align-middle">Setores</span>
                            </a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane active" id="contacts" aria-labelledby="contacts" role="tabpanel">
                                ...
                                <div class="col-xl-3 col-sm-6 col-md-6">
                                    <div class="card">
                                        <div class="card-body cards-geral">
                                            <i class="fa-solid fa-building font-large-1 color-green-dark-geral"></i>
                                            <div class="card-produtos-quantidade ms-3">
                                                <h5 class="mb-0 me-2 itenscadastrados registered-users color-green-dark-geral">{{$totalSectors}}</h5>
                                                <b class="text-muted">Setores Cadastrados</b>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <b class="title-geral-etapas">Lista de Setores</b>
                                            <a href="{{route('sectors.view-create')}}"
