...
@section('content')
    <section class="index-apointments">
                        ...
                        <div class="tab-pane active" id="contacts" aria-labelledby="contacts" role="tabpanel">
                                ...
                                <div class="col-xl-3 col-sm-6 col-md-6">
                                    <div class="card">
                                        <div class="card-body cards-geral">
                                            <i class="fa-solid fa-calendar-check font-large-1 color-green-dark-geral"></i>
                                            <div class="card-produtos-quantidade ms-3">
                                                <h5 class="mb-0 me-2 itenscadastrados registered-users color-green-dark-geral">
                                                    {{$totalAppointments}}</h5>
                                                <b class="text-muted">Agendamentos Cadastrados</b>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <b class="title-geral-etapas">Lista de Agendamentos</b>
                                            <a href="{{route('appointments.view-create')}}"
                                               class="btn button_register float-end ms-2 buttonInsert">
                                                <i class='fa-solid fa-plus'></i> Iniciar Agendamento
                                            </a>
                                        </div>
                                        <div class="card-content">
