    ...
    <div class="authentication-wrapper authentication-cover">
            <div class="authentication-inner row">
                ...
                <div class="flex-row text-center mx-auto">
                    <img src="{{asset('images/Login.png')}}" alt="Backgroud imagem login"
                ...
                <div class="w-px-400 mx-auto w-100">
                    <div class="app-brand mb-4">
                        <a href="#" class="app-brand-link gap-2 mb-2">
                            <span class="app-brand-logo demo">
                                <img class="img-fluid" src="{{asset('images/logo-login.png')}}" alt="Logo Pet Care">
                            </span>
                        </a>
                    </div>
                    ...
                    <form id="formAuthentication" class="mb-3" action="{{ route('authenticate') }}"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn__login btn-lg w-100">
