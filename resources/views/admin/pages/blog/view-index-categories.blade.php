                ...
                <div class="card-content">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-cadastros">
                            ...
                            <li class="breadcrumb-item active">Categorias Notícias</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-12 col-md-12 col-xl-12">
                <div class="card-content">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" id="contacts-tab" href="{{route('blog.view-index-categories')}}"
                               aria-controls="contacts" role="tab"
                               aria-selected="true">
                        ...
                        <div class="tab-pane active" id="contacts" aria-labelledby="contacts" role="tabpanel">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <b class="title-geral-etapas">Lista de Categorias das Notícias</b>
                                            <a href="{{route('blog.view-create-categories')}}"
