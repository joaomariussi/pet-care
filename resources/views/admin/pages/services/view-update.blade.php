    ...
    <section class="insert-positions">
        <div class="row">
            <div class="col-12 col-xl-12">
                ...
                <b class="title-geral-etapas">Editar Serviço - {{$service->name}}</b>
                <p class="sub-title-geral-etapas">Edite as informações do serviço.</p>

                <form method="POST" action="{{route('services.update', $service->id)}}"
                      class="form form-insert-positions">
                    @csrf
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control @error('description') is-invalid @enderror"
                                                                      id="description" name="description" placeholder="Descrição do Serviço"
                                                                      rows="1" style="white-space: pre-wrap;">{{ old('description') ?? $service->description }}
                                                            </textarea>
                                                            @error('description')
                                                            <div class="invalid-feedback">
                                                                {{$message}}
                                                            ...
                                                            is-invalid @enderror" id="category_id" name="category_id">
                                                                ...
                                                                @foreach($categories as $category)
                                                                    <option value="{{$category->id}}"
                                                                        {{ (old('category_id') ? old('category_id') :
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            is-invalid @enderror" id="simultaneous_services"
                                                                   ...
                                                                   value="{{ old('simultaneous_services') ?? $service->simultaneous_services }}">
