    ...
    <section class="insert-positions">
        <div class="row">
            <div class="col-12 col-xl-12">
                ...
                <b class="title-geral-etapas">Editar Funcionário - {{$employee->name}}</b>
                <p class="sub-title-geral-etapas">Edite as informações do funcionário.</p>
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            @error('email') is-invalid @enderror" id="email" name="email"
                                                                   required placeholder="E-mail do Funcionário"
                                                            ...
                                                            <select class="form-control @error('position_id') is-invalid @enderror" id="position_id" name="position_id">
                                                                ...
                                                                @foreach($positions as $position)
                                                                    <option value="{{ $position->id }}"
                                                                        {{ (old('position_id') ? old('position_id') :
