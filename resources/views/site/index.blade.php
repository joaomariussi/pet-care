    ...
    <section class="bg-light-gray big-section" id="portfolio">
        ...
        <div class="container" style="max-width: max-content;">
            <div class="row g-3 margin-15px-bottom">
                <div class="col-12 col-md-3 col-sm-6">
                    <div class="grid-item photography wow animate__fadeIn" data-wow-delay="0.2s">
                        <a href="https://vendasonline.cassul.com.br/linha-pet?order_by=final_price.asc" title="Linha de Produtos Per" target="_blank">
                ...
                <div class="col-12 col-md-3 col-sm-6">
                    <div class="grid-item photography wow animate__fadeIn" data-wow-delay="0.2s">
                        <a href="https://vendasonline.cassul.com.br/linha-grandes?order_by=final_price.asc" title="Linha de produtos Grandes Animais" target="_blank">
                            <div class="portfolio-box">
                                <div class="portfolio-image">
                ...
                <div class="col-12 col-md-3 col-sm-6">
                    <div class="grid-item photography logos wow animate__fadeIn">
                        <a href="https://vendasonline.cassul.com.br/linha-agro?order_by=final_price.asc" title="Linha de produtos Agro" target="_blank">
                            <div class="portfolio-box">
                                <div class="portfolio-image">
            ...
            <div class="row g-3">
                <div class="col-12 col-md-3 col-sm-6">
                    <div class="grid-item photography logos wow animate__fadeIn">
                        <a href="https://vendasonline.cassul.com.br/linha-garden?order_by=final_price.asc" title="Linha de produtos Garden" target="_blank">
                            <div class="portfolio-box">
                                <div class="portfolio-image">
                ...
                <div class="col-12 col-md-3 col-sm-6">
                    <div class="grid-item logos web photography wow animate__fadeIn" data-wow-delay="0.4s">
                        <a href="https://vendasonline.cassul.com.br/linha-ferragens?order_by=final_price.asc" title="Linha de produtos Ferragens" target="_blank">
                            <div class="portfolio-box">
                                <div class="portfolio-image">
                ...
                <div class="col-12 col-md-3 col-sm-6">
                    <div class="grid-item photography logos wow animate__fadeIn">
                        <a href="https://vendasonline.cassul.com.br/linha-epi?order_by=final_price.asc" title="Linha de produtos EPI's" target="_blank">
                            <div class="portfolio-box">
                                <div class="portfolio-image">
                ...
                <div class="col-12 col-md-3 col-sm-6">
                    <div class="grid-item photography wow animate__fadeIn" data-wow-delay="0.2s">
                        <a href="https://vendasonline.cassul.com.br/linha-domissanitaria?order_by=final_price.asc" title="Linha de produtos Domissanitários" target="_blank">
                            <div class="portfolio-box">
                                <div class="portfolio-image">
    ...
    <section class="bg-white wow animate__fadeIn">
        <div class="container">
                ...
                <div class="col-12 blog-content">
                    <ul class="blog-grid blog-wrapper grid grid-loading grid-3col xl-grid-3col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-extra-large">
                        ...
                        @if ($notices->count() > 0)
                                ...
                                <li class="grid-item wow animate__fadeIn">
                                    <div class="blog-post border-radius-5px bg-white box-shadow-medium">
                                        <div class="blog-post-image bg-medium-slate-blue">
                                            ...
                                            <a href="{{route('notices-blog.view-notice-category', ['slug' => $notice['categoryBlog']['slug']])}}"
                                        ...
                                        <div class="post-details padding-3-rem-lr padding-2-half-rem-tb">
                                            <a href="{{route('notices-blog.view-details-notices', ['slug' => $notice['slug']])}}" class="alt-font text-small text-shamrock-green-hover d-inline-block margin-10px-bottom">
                                            ...
                                            <a href="{{route('notices-blog.view-details-notices', ['slug' => $notice['slug']])}}"
                                               class="alt-font font-weight-500 text-extra-medium text-extra-dark-gray
                                                text-shamrock-green-hover margin-15px-bottom d-block">
                                                {{$notice['title']}}
                                            </a>
                            ...
                            @endforeach
                        @else
                            <li class="w-100 text-center grid-item wow animate__fadeIn">
                                <h2 class="alt-font text-extra-dark-gray font-weight-600 mb-0">Ops!</h2>
            ...
            @if ($notices->count() > 0)
                <div class="row">
                    <div class="col-12 text-center">
                        <a href="{{route('notices-blog.view-all-notices')}}" title="Visualizar todas as matérias"
                           class="btn btn-link thin btn-extra-large text-extra-dark-gray margin-70px-top d-inline-block md-margin-40px-top sm-margin-20px-top">
