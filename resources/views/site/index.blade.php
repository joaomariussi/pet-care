                ...
                <div class="col-12 blog-content">
                    <ul class="blog-grid blog-wrapper grid grid-loading grid-3col xl-grid-3col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-extra-large">
                        ...
                        @foreach($notices as $notice)
                            @foreach($notice['noticesBlog'] as $noticesBlog)
                                <li class="grid-item wow animate__fadeIn">
                                    <div class="blog-post border-radius-5px bg-white box-shadow-medium">
                                        <div class="blog-post-image bg-medium-slate-blue">
                                            ...
                                            <a href="blog-masonry.html" class="blog-category alt-font">{{$notice['name-category']}}</a>
                                        </div>
                                        <div class="post-details padding-3-rem-lr padding-2-half-rem-tb">
                                            <a href="{{route('notices-blog.view-details-notices', $noticesBlog['id'])}}" class="alt-font text-small text-shamrock-green-hover d-inline-block margin-10px-bottom">
                                                {{ \Carbon\Carbon::parse($noticesBlog['created_at'])->locale('pt_BR')->isoFormat('D [de] MMMM [de] YYYY') }}
                                            </a>
                                            <a href="{{route('notices-blog.view-details-notices', $noticesBlog['id'])}}" class="alt-font font-weight-500 text-extra-medium text-extra-dark-gray
